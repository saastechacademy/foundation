...
### Phase 6: Settlement ✅ Implemented

> For the return/exchange settlement service -- why OOTB settlement fails, the custom
> `HotWaxAutoPostReturnSettlementService` design, the test-data-creation scripts built to verify
> it, real build-time technical discoveries, and current test scenario results -- see
> **[return_invoice_settlement.md](./return_invoice_settlement.md)**.

**Status**: Implemented in PR [hotwax/dynamics365-integration#36](https://github.com/hotwax/dynamics365-integration/pull/36) (closes issue [#35](https://github.com/hotwax/dynamics365-integration/issues/35)). 7 of 9 test scenarios verified in dev as of 2026-07-07; lower-value exchange with store credit and pure store credit remain pending. See `return_invoice_settlement.md` Section 7 for the full scenario matrix.
